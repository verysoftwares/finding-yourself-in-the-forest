  ...
  ['Move'] = function()
    ...
    elseif (place.x==228 and place.y==112) or (hspot.nextx==228 and hspot.nexty==112) then
      ...
      if not place.loop then if place.x==204 and place.y==112 then place.loop=1 else place.loop=12 end; place.x=hspot.nextx; place.y=hspot.nexty
      		...
      		if hspot.nexty>112 then place.loop=place.loop+1; if place.loop>12 then place.x=228; place.y=0; place.loop=nil end 
        elseif hspot.nexty<112 then place.loop=place.loop-1; if place.loop<1 then place.x=204; place.y=112; place.loop=nil end 
        end
     	end
    else
